...
const productSchema = new mongoose.Schema(
  {
    ...
    // REMOVED: The 'category' field. This was the source of the validation error.
    // REMOVED: The comment about 'productType' being replaced with 'category' is now obsolete.
