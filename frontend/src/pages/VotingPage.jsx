...
import { useState, useEffect } from 'react'; // Removed useRef as it's not used here
import {
...
export default function VotingPage() {
    ...
    const [error, setError] = useState(''); // Ensures 'error' state is defined
    ...
    if (error) { // Now 'error' state variable is correctly defined and used
        return (
    ...
    return (
        <Box maxW="container.lg" mx="auto" mt={{base:6, md:8}} px={4} pb={10}>
            <VStack spacing={4} align="center" mb={8}>
                <Heading as="h1" size="2xl" color="brand.textLight">🏆 Monthly Design Contest 🏆</Heading>
                {user && (
                    <>
