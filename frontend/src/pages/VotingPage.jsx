...
import { useState, useEffect, useRef } from 'react'; // Ensured useRef is here
import {
...
export default function VotingPage() {
    ...
    const cancelRef = useRef(); // Although AlertDialog is not used, if you add it, this is ready. For now, it's unused.
