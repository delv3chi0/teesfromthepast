    ...
    <Box maxW="6xl" pb={10}>
      ...
      {user &&
        <Heading
          ...
          textAlign="left"
          color="brand.textLight"
          fontWeight="normal" // Keep this lighter than the main page title
        >
      ...
      <VStack align="stretch" spacing={{ base: 6, md: 10 }}>
        <Box>
          <Heading
            as="h2" // This is a section title, can use a different size or theme's default
            size={{ base: "lg", md: "xl" }} // Keeping this distinct from pageTitle for hierarchy
            fontFamily="body" // Use Montserrat for section titles for consistency if desired
            fontWeight="bold"
            mb={{ base: 4, md: 6 }}
            pb={2}
            color="brand.textLight"
