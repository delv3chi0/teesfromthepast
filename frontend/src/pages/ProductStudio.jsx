  ...
  useEffect(() => {
    ...
    const onTransform = () => {
      ...
      const edges = [
        ...
        { d: bb.top - a.top, axis: "h", line: a.top },
        { d: bb.top + bb.height - (a.top + a.height), axis: "h", line: a.top + a.height },
      ];
      edges.forEach(e => {
        if (Math.abs(e.d) < SNAP) {
          if (e.axis === "v") { o.left -= e.d; snapV = true; }
          else { o.top -= e.d; snapH = true; }
        }
      });
