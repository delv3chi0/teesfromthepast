...
// Cloudinary mockups map generated by your script (default export)
...
export default function ProductStudio() {
  ...
  // --- MOCKUP PICKER (uses Cloudinary map first) ---
  ...
  const refreshBackground = useCallback(() => {
    ...
    window.fabric.Image.fromURL(mockupUrl, (img) => {
      ...
      const rect = new window.fabric.Rect({
        id: "printArea", left: fc.width / 2, top: fc.height / 2, originX: "center", originY: "center",
        width: pxW, height: pxH, fill: "", stroke: "white", strokeDashArray: [6, 6], strokeWidth: 2,
