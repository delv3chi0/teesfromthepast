 ...
 * - All text and link colors changed to light/accent variants for visibility.
 * - Form inputs and buttons completely restyled for a dark, professional aesthetic.
 * - Standardized feedback messages (success/error) for better UX and consistency.
 */
    ...
    return (
        <VStack spacing={6}>
            ...
            <form onSubmit={handleSubmit} style={{ width: '100%' }}>
                <VStack spacing={5}>
                    <FormControl isRequired isInvalid={!!error.includes('password') || (password.length > 0 && password.length < 6)}>
