    ...
    return (
      <Box maxW="container.lg" mx="auto" p={8}>
        <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={8}>
          <GridItem>
            <Skeleton height={{ base: "300px", md: "500px" }} />
            <HStack mt={4} spacing={4}><Skeleton height="60px" width="60px" /><Skeleton height="60px" width="60px" /><Skeleton height="60px" width="60px" /></HStack>
          </GridItem>
          <GridItem>
            <SkeletonText noOfLines={1} height="40px" />
            <SkeletonText noOfLines={1} height="30px" mt={4} width="150px" />
            <SkeletonText noOfLines={6} mt={6} />
          </GridItem>
        </Grid>
      </Box>
    );
          ...
          <VStack spacing={4} align="stretch">
            <Box bg="gray.100" borderRadius="lg" p={4} display="flex" justifyContent="center" alignItems="center">
              <Image 
                ...
                maxH="500px" 
                objectFit="contain" 
                fallback={<Icon as={FaImage} boxSize="100px" color="gray.300"/>}
              />
            </Box>
