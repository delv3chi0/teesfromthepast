...
import {
  Box, Flex, VStack, Link as ChakraLink, IconButton, useDisclosure, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, Image, Avatar,
  HStack, // <-- THE FIX: Added missing HStack import
  Icon, Spacer, useBreakpointValue, Container
