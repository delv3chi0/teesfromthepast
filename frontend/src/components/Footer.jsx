...
import { Box, Text, HStack, Link as ChakraLink, Icon, VStack, Divider } from '@chakra-ui/react'; // Added VStack and Divider for structure
import { Link as RouterLink } from 'react-router-dom';
import { FaFacebook, FaTwitter, FaInstagram } from 'react-icons/fa'; // Your existing social icons
...
export default function Footer() {
  return (
    <Box
      as="footer"
      textAlign="center"
      py={6} // Slightly increased padding for a bit more space
      px={4}
    ...
    >
      <VStack spacing={4}>
        <HStack spacing={{base: 3, md: 6}} fontSize={{base: "xs", md: "sm"}} flexWrap="wrap" justifyContent="center">
          {/* You can add more links here if needed, e.g., About Us, FAQ */}
          ...
          <Text display={{base: "none", md: "inline"}}>|</Text> 
          <ChakraLink as={RouterLink} to="/terms-of-service" _hover={{ textDecoration: "underline", color: "brand.accentYellow" }}> {/* Example link */}
            Terms of Service
          </ChakraLink>
        </HStack>

        <Divider width="50%" borderColor="brand.primary" /> {/* Subtle divider */}
